...
class Chatbot < Sandbox::Script
  ...
  class CmdHello < CmdBase
    ...
    FLOOD_TIME_MULTI = 8
    GREETINGS = [
      "ПРИВЕТ [8ccbff]%[6aab7f]!",
      "АЛОХА [8ccbff]%[6aab7f]!",
      "ЧО КАК [8ccbff]%[6aab7f]? КАК САМ?",
      "КАВАБАНГА [8ccbff]%[6aab7f]!",
      "КАК НАМ ТЕБЯ НЕ ХВАТАЛО [8ccbff]%[6aab7f]!",
      "ПРИВЕТСТВУЮ [8ccbff]%[6aab7f]!",
      "ВИДЕЛИСЬ [8ccbff]%[6aab7f]!",
      "ЗДРАВСТВУЙ [8ccbff]%[6aab7f]!",
      "БОНСУАР [8ccbff]%[6aab7f]!",
      "КОНИЧИВА [8ccbff]%[6aab7f]!",
      "ГУТЕН ТАГ [8ccbff]%[6aab7f]!",
      "ШАЛОМ [8ccbff]%[6aab7f]!",
      "[8ccbff]%[6aab7f] А ТЫ ЗНАЕШЬ ЧТО ТАКОЕ БЕЗУМИЕ?",
    ]
  ...
  class CmdPerson < CmdBase
    ...
    ANSWERS = [
      "ЧТО ТЕБЕ НУЖНО [8ccbff]%[7fffa7]?",
      "ТЫ МЕНЯ ЗВАЛ [8ccbff]%[7fffa7]?",
      "ВСЕГДА ГОТОВ [8ccbff]%[7fffa7]!",
      "Я НИЧЕГО ОБ ЭТОМ НЕ ЗНАЮ [8ccbff]%[7fffa7]!",
      "Я НЕ ВИНОВАТ [8ccbff]%[7fffa7]! ОНО САМО!",
      "Я ПОДУМАЮ НАД ЭТИМ [8ccbff]%[7fffa7]!",
      "ПОЛОСТЬЮ С ТОБОЙ СОГЛАСЕН [8ccbff]%[7fffa7]!",
      "НИЗАЧТО [8ccbff]%[7fffa7]!",
      "[8ccbff]%[7fffa7] А ТЫ КОГДА-НИБУДЬ ПРОБОВАЛ ЛИЗНУТЬ ЛУНУ?",
      "[8ccbff]%[7fffa7] КОНЕЧНО!",
      "[8ccbff]%[7fffa7] НЕТ, А ТЫ?",
      "ЛАДНО [8ccbff]%[7fffa7]!",
      "ХОРОШО [8ccbff]%[7fffa7]!",
      "ТАКОГО Я НЕ ОЖИДАЛ ОТ ТЕБЯ [8ccbff]%[7fffa7]!",
      "[8ccbff]%[7fffa7] ЭТО ПРОСТО НЕ ПРИЛИЧНО!",
      "[8ccbff]%[7fffa7] ТЫ ТАКОЙ КЛАССНЫЙ!",
      "Я НЕ МОГУ [8ccbff]%[7fffa7], У МЕНЯ ЛАПКИ!",
      "[8ccbff]%[7fffa7] ЕСЛИ ТЕБЕ ИНТЕРЕСНО, ТОЧНОЕ ВРЕМЯ [ffe5af]@[7fffa7]!",
    ]
